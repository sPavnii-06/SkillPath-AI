...
const RoadmapPage = () => {
  ...
  const [videoData, setVideoData] = useState({ open: false, url: '', topic: '' })
  ...
  return (
    <DashboardLayout>
      <div className="animate-fade-up">
                ...
                <div className="roadmap-step__body">
                  ...
                  {!done && (
                    <div style={{ display: 'flex', gap: 'var(--space-3)', marginTop: 'var(--space-4)', flexWrap: 'wrap' }}>
                      ...
                      {step.videoUrl && (
                        <Button variant="primary" size="sm" onClick={() => setVideoData({ open: true, url: step.videoUrl, topic: step.title })}>
                          ▶ Watch Video
                        </Button>
                      )}
                    </div>
        ...
        <VideoModal 
          isOpen={videoData.open}
          onClose={() => setVideoData(prev => ({ ...prev, open: false }))}
          videoUrl={videoData.url}
          topicTitle={videoData.topic}
        />
      </div>
    </DashboardLayout>
  )
